...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
      ...
      <li class="menu-item active open">
        ...
        <ul class="menu-sub">
          ...
          <x-active-menu-items :active="request()->is('reservations/home-create-rooms')"></x-active-menu-items>
            <a  href="/reservations/home-create-rooms"  class="menu-link" wire:navigate >
          Rooms
            </a>
          </li>
          <x-active-menu-items :active="request()->is('reservations/home-create-room-category')"></x-active-menu-items>
            <a   href="/reservations/home-create-room-category" class="menu-link" wire:navigated >
            Room Category
            </a>
          </li>
          <x-active-menu-items :active="request()->is('reservations/home-room-allocation')"></x-active-menu-items>
          <a   href="/reservations/home-room-allocation" class="menu-link" wire:navigated>
          Rooms Allocations
            </a>
          </li>
          <x-active-menu-items :active="request()->is('reservations/available-rooms')"></x-active-menu-items>
          <a href="/reservations/available-rooms" class="menu-link" wire:navigated>
          Available Rooms
            </a>
          </li>
          <x-active-menu-items :active="request()->is('reservations/reservations')"></x-active-menu-items>
          <a  href="/reservations/reservations" class="menu-link" wire:navigated >
          Book a Room
            </a>
          </li>
          <x-active-menu-items :active="request()->is('reservations/reserved-rooms')"></x-active-menu-items>
          <a href="/reservations/reserved-rooms" class="menu-link" wire:navigated>
        Reserved Rooms
          </a>
        </li>
        <x-active-menu-items :active="request()->is('reservations/due-rooms')"></x-active-menu-items>
        <a  href="/reservations/due-rooms" class="menu-link" wire:navigated>
      Due Rooms
        </a>
      </li>
      <x-active-menu-items :active="request()->is('reservations/due-rooms')"></x-active-menu-items>
    ...
    Room Checkouts
      ...
      <a   href="#" class="menu-link" wire:navigated>
  ...
  Abandoned Reservations
      ...
      <a  href="/reservations/reservation-feeds" class="menu-link" wire:navigated>
    Reservation Feeds
      </a>
    </li>
        </ul>
