                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="text-center mb-6">
                            ...
                            <h4 class="mb-2">
                                <x-home-page-label>{{$modal_title}}</x-home-page-label>
                            </h4>
                        </div>
                        ...
                        <select wire:model="category_id" class="select2 form-select form-select-lg"
                        ...
                        <div class="input-group input-group-merge">
                            <input wire:model='price' class="form-control form-control-lg" type="text"
                                aria-describedby="modalAllocate" />
